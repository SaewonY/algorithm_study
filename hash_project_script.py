...
def generate_records(length_of_name, list_of_domains, total_records, list_of_quotes):
    with open("data.txt", "w") as f:
        for num in range(total_records):
            ...
            f.write(key + ":" + value + "\n")
        f.write("mashrur@example.com:Don't llet me leave Murph\n")
        f.write("evgeny@example.com:All I do is win win win no matter what!\n")
    
generate_records(10, list_of_domains, 10000, quotes)