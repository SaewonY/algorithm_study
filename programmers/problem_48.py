...
def solution(n, arr1, arr2):
    ...
    for num, num1 in zip(arr1, arr2):
    
        bin_num = str(format(num, 'b')) 
        bin_num = bin_num.rjust(n, '0') if len(bin_num) < n else bin_num
    
        bin_num1 = str(format(num1, 'b'))
        bin_num1 = bin_num1.rjust(n, '0') if len(bin_num1) < n else bin_num1
        
        temp = ''
        
        for string, string1 in zip(bin_num, bin_num1):
            if string == '1' or string1 == '1':
                temp += '#'
            else:
                temp += ' '
